...
csv_filename    = 'csvs/week_day/time_mistake/tun_phi_normal/jac.csv'
...
csv_filename    = 'csvs/week_day/time_mistake/tun_phi_normal/tun_phi.csv'
column_headers = ['sequence_number', 'time_taken_to_correct_ns']
...
csv_filename    = 'csvs/week_day/time_mistake/tun_phi_normal/estimated.csv'
column_headers = ['sequence_number', 'time_taken_to_correct_ns']
